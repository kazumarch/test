...
class TopsController extends AppController
{
    ...
    public function add()
    {
        // $top = $this->Tops->newEntity();
        // if ($this->request->is('post')) {
        //     $top = $this->Tops->patchEntity($top, $this->request->getData());
        //     if ($this->Tops->save($top)) {
